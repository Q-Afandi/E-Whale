...
public class KurirModelTable extends AbstractTableModel {
    ...
    public Object getValueAt(int row, int col) {
        ...
        switch (col) {
            ...
            case 1:
                ...
                value = rowItem.getNoTeleponKurir();
                break;
            // Jika col bernilai 2
            case 2:
                // Set value dengan alamat dari rowItem
                value = rowItem.getAlamatKurir();
                break;
            case 3:
                // Set value dengan alamat dari rowItem
                value = rowItem.getNoKK();
                break;
            case 4:
                // Set value dengan alamat dari rowItem
                value = rowItem.getNoKTP();
                break;
        }
    ...
    public void update(Kurir value) {
        ...
        for (Kurir b : data) {
            ...
            if (b.getIdKurir().equals(value.getIdKurir())) {
    ...
    public void delete(Kurir value) {
        // Membuat variable i untuk menyimpan index dari data
        int i = 0;
