 ...
 * @author ACER
 */
public class KonversiPoinModelTable extends AbstractTableModel {
     // Array columnNames untuk menyimpan nama-nama kolom
    private String[] columnNames = {"JenisSampah", "KategoriSampah", "PoinSampah"};
    // Membuat List dengan nama data yang berisi Biodata untuk menyimpan data dari input
    private List<KonversiPoin> data;

    // Constructor ModelTable dengan parameter List<Biodata> data
    public KonversiPoinModelTable (List<KonversiPoin> data) {
    ...
    public Object getValueAt(int row, int col) {
        ...
        KonversiPoin rowItem = data.get(row);
    ...
    public void add(KonversiPoin value) {
    ...
    public void delete(KonversiPoin value) {
        // Membuat variable i untuk menyimpan index dari data
        int i = 0;
