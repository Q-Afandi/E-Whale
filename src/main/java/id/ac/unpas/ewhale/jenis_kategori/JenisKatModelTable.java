...
public class JenisKatModelTable extends AbstractTableModel {
    ...
    public void add(JenisKat value) {
    ...
    public void update(JenisKat value) {
    ...
    public void delete(JenisKat value) {
        // Membuat variable i untuk menyimpan index dari data
        int i = 0;
